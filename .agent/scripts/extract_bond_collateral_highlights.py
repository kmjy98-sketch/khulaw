...
pdf_dir = r"H:\내 드라이브\리퀴드텍스트 참조\분할"
output_dir = r"C:\Users\111\.gemini\antigravity\scratch\extracted_highlights"

os.makedirs(output_dir, exist_ok=True)

pdf_files = [f for f in os.listdir(pdf_dir) if f.lower().endswith(".pdf") and "채권담보" in f]

print(f"Target directory: {pdf_dir}")
print(f"Output directory: {output_dir}")
print(f"Found {len(pdf_files)} PDF files relating to '채권담보' to process.")
