...
TARGETS = [
    (
        r"1.민사\30.송영곤_기본민법\기타\1-1_[송영곤_변호사]_2026_논점민강12판_보충자료1-26.1.11_1_26.pdf",
        "1민사__30송영곤_기본민법__기타__송영곤_논점민강12판_보충자료1_26111",
        "보충자료1_1.11",
        [r"1.민사\30.송영곤_기본민법\(1-1)[송영곤 변호사] 2026 논점민강(12판) 보충자료(1)-26.1.11.pdf"],
    ),
    (
        r"1.민사\30.송영곤_기본민법\기타\송영곤_논점민강12판_보충자료1-26.1.25..pdf",
        "1민사__30송영곤_기본민법__기타__송영곤_논점민강12판_보충자료1_26125",
        "보충자료1_1.25",
        [r"1.민사\30.송영곤_기본민법\(1)[송영곤 변호사] 2026 논점민강(12판) 보충자료(1)-26.1.25..pdf"],
    ),
    (
        r"1.민사\30.송영곤_기본민법\기타\2-1[송영곤_변호사]_2026_논점민강12판_보충자료2-26.2.2._26.pdf",
        "1민사__30송영곤_기본민법__기타__송영곤_논점민강12판_보충자료2_2622",
        "보충자료2_2.2",
        [r"1.민사\30.송영곤_기본민법\(2-1)[송영곤 변호사] 2026 논점민강(12판) 보충자료(2)-26.2.2..pdf"],
    ),
    (
