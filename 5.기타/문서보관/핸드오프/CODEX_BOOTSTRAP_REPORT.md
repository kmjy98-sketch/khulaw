...
---
(H:\내 드라이브\sync\`CODEX_BOOTSTRAP_REPORT.md)보고서 기준으로 작업을 수행. 현재 룰 스킬과 안

1. 기존 안키카드 백업 후 진행. 데이터 삭제는 어떤 경우에도 금지. 필요시 서버 밖으로 이전

2. 현재 룰 스킬 들과 충돌하는 부분, 또는 대체가능한 부분 검토
