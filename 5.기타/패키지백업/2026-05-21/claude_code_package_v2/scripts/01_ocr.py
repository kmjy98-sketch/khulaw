"""
01번 OCR 파이프라인 (v3.6 Phase 1.1 — Claude 교체판).
Anthropic Claude API (Sonnet 4.6 default, Haiku 4.5 옵션)로
PDF 청크 → 마킹/구조/조문 추출 → outputs/01_ocr/

v3.6 Phase 1 (2026-05): Gemini 3.1 Pro 사용
v3.6 Phase 1.1 (2026-05): 사용자 결정으로 Claude로 교체 (AI Studio 미사용 방향)
